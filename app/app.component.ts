...
const originalData = [
  { id: 1, name: 'Hydrogen', weight: 1.0079, descriptions: [{name:'row1',age: 'row2'},{name:'row1',age: 'row2'}] },
  { id: 2, name: 'Helium', weight: 4.0026, descriptions: [{name:'row2.1',age: 'row2.2'}] },
  { id: 3, name: 'Lithium', weight: 6.941, descriptions: [{name:'row3.1',age: 'row3.2'},{name:'row1',age: 'row2'},{name:'row1',age: 'row2'}] },
  { id: 4, name: 'Beryllium', weight: 9.0122, descriptions: [{name:'row2.1',age: 'row2.2'}] },

]

const DATA2 = originalData2.reduce((current, next) => {
  next.child.forEach(b => {
    current.push({ financialYear: next.financialYear, quarterName: next.quarterName, child: b })
  });
  return current;
}, []);
